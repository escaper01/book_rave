  ...
  return (
    <footer className=' w-full bg-my-khaki-primary py-7 '>
      <div className='mx-4 grid grid-cols-1 justify-items-center  gap-2  sm:grid-cols-3 lg:mx-20'>
        <div className='px-auto flex max-w-sm flex-col text-center text-sm capitalize'>
          <div className='font-bold leading-8'>Main navigation</div>
          <Link href='/trending_posts'>trending posts</Link>
          <Link href='/books'>books</Link>
          <Link href='/newly-added'>browse</Link>
        </div>
        <div className='flex max-w-sm flex-col text-center text-sm capitalize'>
